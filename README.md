...
[Latest beta: v0.8.9-beta1](https://github.com/Master0fFate/pi-fategui/releases/tag/v0.8.9-beta1) · [Installation](#installation) · [Capabilities](#what-fate-ui-provides) · [Themes](#themes) · [Development](#local-development) · [Security](SECURITY.md) · [Contributing](CONTRIBUTING.md)
