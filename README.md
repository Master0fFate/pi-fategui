...
- **Agent orchestration.** Recursive Agent Teams V2 with optional per-child local Git worktrees and explicit review/integration, or isolated legacy sessions. Configure each child's model, tools, skills, and permissions. See [Agent orchestration](docs/agent-orchestration.md).
