            ...
            <div ref={settingsScroll} className="settings-scroll">
              ...
              {activeSection === 'agent' && (
                <div className="settings-panel" role="tabpanel" id="settings-panel-agent" aria-labelledby="settings-tab-agent">
                  <div className="settings-title"><span><Bot size={17} /></span><div><h3>Agent defaults</h3><p>Choose where new sessions begin. You can still change these in the composer.</p></div></div>
