// Monaco's package root registers every bundled grammar plus the optional LSP
// client. Fate UI previews a deliberately smaller, explicit language contract;
// keep the complete editor interaction surface while loading only those modes.
...
// Preserve editor.main's complete standalone editing and diff behavior.
