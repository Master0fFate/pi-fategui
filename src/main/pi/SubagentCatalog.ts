...
export async function buildSubagentCatalog(
  ...
  const capabilities = [
    ...
    'Budgets: maxCostUsd, maxInputTokens, maxOutputTokens, maxTotalTokens, maxTurns. Enforcement occurs at observable assistant-message boundaries.',
    ...
    'Duration: timeoutSeconds and idleTimeoutSeconds are opt-in; omit or set zero for no automatic stop. Positive mailbox lifetimes, manage waits, and follow-up limits may be as long as the orchestrator chooses.',
