...
- `pnpm package` produces a target-native Fate UI unpacked application; `pnpm smoke:packaged` verifies renderer startup and unpacked node-pty binaries. CI repeats this on Windows, macOS, and Linux hosts.
