...
test('first launch, project, prompt, tool, diff, Git graph, worktrees, and session switching', async () => {
  ...
  try {
    ...
    expect(chatFontRouting.assistant).toBe(chatFontRouting.interfaceFont);
    expect(chatFontRouting.toolSummary).toBe(chatFontRouting.interfaceFont);
    expect(chatFontRouting.toolDetails).toBe(chatFontRouting.interfaceFont);
